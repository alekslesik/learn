...
func GetImage(key, secret string, params Params) (chan Image, chan error) {
	i := make(chan Image)
	e := make(chan error)
...
func (k *Kandinsky) Check(url string, u UUID) (chan Image, chan error) {
